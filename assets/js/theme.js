...
(function($) {
    ...
    $(".stackly-service-card").hover(function() {
        $(".stackly-service-card").removeClass("item-active");
...
window.addEventListener("load", function(){
    ...
    if(cookieTheme){
        ...
        const themeValue = cookieTheme.split("=")[1];
...
$(window).on('resize', function () {
    ...
    resizeTimer = setTimeout(function(){
        ...
        if ($('.hero-image-slider-top').hasClass('slick-initialized')) {
            $('.hero-image-slider-top').slick('unslick');
        }

        if ($('.hero-image-slider-bottom').hasClass('slick-initialized')) {
            $('.hero-image-slider-bottom').slick('unslick');
        }
